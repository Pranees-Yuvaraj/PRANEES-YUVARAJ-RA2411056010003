class BankAccount:
    ...
    def deposit(self,amount):
        ...
        self.send_email(
            self.name,
            f"Your deposit of Rs. {amount} was successful. New balance: {self.balance}"
        )
    ...
    def withdraw(self,amount,entered_pin):
        ...
        self.send_email(
            self.name,
            f"Your withdrawal of Rs. {amount} was successful. New balance: {self.balance}"
        )
    ...
    def print_statement(self):
        print(f"Statement for Account #{self.account_number} ({self.name})")
